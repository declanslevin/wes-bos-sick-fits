...
export declare type LinkProps = Omit<NextLinkProps, 'passHref'> & Omit<AnchorHTMLAttributes<HTMLAnchorElement>, 'href'>;
export declare const Link: ({ href, as, replace, scroll, shallow, prefetch, ...props }: LinkProps) => JSX.Element;
