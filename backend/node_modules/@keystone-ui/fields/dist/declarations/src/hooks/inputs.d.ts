...
export declare function useInputStyles({ invalid, tokens }: InputStylesProps): {
    ...
    readonly outline: 0;
    readonly paddingBottom: import("react").ReactText;
    readonly paddingLeft: import("react").ReactText;
    readonly paddingRight: import("react").ReactText;
    readonly paddingTop: import("react").ReactText;
