...
export declare type IconProps = SVGAttributes<SVGSVGElement> & {
...
export declare const createIcon: (children: ReactNode, name: string) => import("react").ForwardRefExoticComponent<SVGAttributes<SVGSVGElement> & {
    ...
    /** The size key for the icon. */
    size?: number | "small" | "medium" | "large" | "smallish" | "largish" | readonly ("small" | "medium" | "large" | "smallish" | "largish" | null)[] | undefined;
