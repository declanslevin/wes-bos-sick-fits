...
declare type SharedFieldStateTokens = {
    labelColor?: string;
    legendColor?: string;
    shadow?: string;
};
declare type ControlFieldStateTokens = {
    controlBackground?: string;
    controlBorderColor?: string;
    controlBorderRadius?: number | string;
    controlForeground?: string;
};
declare type InputFieldStateTokens = {
...
declare type FieldStateTokens = SharedFieldStateTokens & ControlFieldStateTokens & InputFieldStateTokens;
declare type FieldTokens = FieldStateTokens & {
